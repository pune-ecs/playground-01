<!doctype html>
<!--
	Template:	 ECS DIGITAL - Responsive One Page HTML5 Template
...
<html lang="en-US">
	<head>
		...
		<title>ECS DIGITAL - Responsive One Page HTML5 Template</title>
		<meta name="description" content="ECS DIGITAL - Responsive One Page HTML5 Template">
                ...
                <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation"> <!-- Classes: navbar-default, navbar-inverse, navbar-fixed-top, navbar-fixed-bottom, navbar-transparent. Note: If you use non-transparent navbar, set "height: 98px;" to #header -->
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand page-scroll" href="index.html">ECS DIGITAL</a>
                    </div>
				...
				<div class="container">
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								<h1>You simply deployed a Web Application using Jenkins Pipeline.</h1>
								<p>Congratulations!!</p>
                                <div class="extra-space-l"></div>
								<a class="btn btn-blank" href="https://ecs-digital.co.uk/" target="_blank" role="button">View More!</a>
							</div>
            	...
            	<div class="container">
                	<div class="row">
                    	...
                    	<div class="col-md-9">
                            ...
                            <p>Inspired by nature, follow technology, appreciate the classics. You can build modern & professional websites with ECS DIGITAL. The possibilities are just endless.</p>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-address">
			                            ...
			                            <li><i class="fa fa-skype"></i> ECS DIGITAL-Design</li>
			                        </ul>
                                </div>
                            </div>
                    	...
                    	<div class="row wow bounceInLeft" data-wow-delay="0.4s">
                            ...
                            <div class="col-sm-12 col-md-4">
                                ...
                                <div class="single-tweet">
                                    <div class="tweet-content"><span>@ECS DIGITAL</span> Excepteur sint occaecat cupidatat non proident</div>
                                    <div class="tweet-date">1 Hour ago</div>
                                </div>
                                <div class="single-tweet">
                                    <div class="tweet-content"><span>@ECS DIGITAL</span> Excepteur sint occaecat cupidatat non proident uku shumaru</div>
                                    <div class="tweet-date">1 Hour ago</div>
                                </div>
                            </div>
